...
const CelestialList: React.FC<CelestialListProps> = ({ onSelectTarget }) => {
                ...
                <div className="p-4 space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      {body.playerMine && (
                        <span className="px-2 py-0.5 bg-green-500/20 text-green-400 rounded text-xs">
                          <img src={minesIcon} alt="" className="w-6 h-6" /> Twoja kopalnia (lv.{body.playerMine.level})
                        </span>
                      )}
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-700">
                    <div className="text-sm text-gray-400">
                      <span><img src={timeIcon} alt="" className="w-6 h-6" /> ~{body.estimatedTravelTime} min</span>
                      <span className="mx-2">•</span>
                      <span><img src={diffIcon} alt="" className="w-6 h-6" /> x{body.miningDifficulty.toFixed(1)} trudność</span>
                    </div>
                    ...
                    >
                      {body.isTemporary ? 'Wyślij misję' : 'Szczegóły'}
                    </button>
                  </div>
                </div>
              </div>
